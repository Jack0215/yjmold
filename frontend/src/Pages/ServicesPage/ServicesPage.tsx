    ...
    <div className="container mx-auto px-4 py-32 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        {servicesList.map((row) => (
          <div
            key={row.id}
            className="bg-white p-8 rounded-lg shadow-lg hover:-translate-y-2 transform duration-300"
          >
            <div className="text-4xl mb-4">{row.icon}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {processList.map((row) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold  mb-2">{row.title}</h3>
      ...
      <div className="mt-32 bg-blue-600 rounded-2xl p-12 text-center text-white">
        ...
        <p className="text-lg mb-8">
          지금 바로 연락주시면 맞춤형 솔루션을 제안해 드리겠습니다.
        </p>
