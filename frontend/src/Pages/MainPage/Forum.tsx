...
const Forum = () => {
  ...
  return (
    <div className="bg-white">
      <div className="container mx-auto px-4 py-28 lg:py0 max-w-6xl">
              ...
              >
                <div className="p-6 flex items-center justify-between">
                  <div className="flex-1 font-semibold">
                    ...
                    <div className="mt-2 text-gray-500 ">{row.createdAt}</div>
                  </div>
